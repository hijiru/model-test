...
export interface Liquidation_Price_paramas{
    wb:number,
    ttm1?:number,
    upnl1?:number,
    cumb?:number,
...
export function Liquidation_Price_calculation(
    {
    wb,
    ttm1 = 0,
    upnl1 = 0,
...
export function named_sheet(named_values:number){
...
let mmrb:number = named_sheet(nv)['margin_rate']
let cumb:number = named_sheet(nv)['Maintenance_Amount']
